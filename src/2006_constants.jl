...
__b_gspin_deuteron = 0.8574382308,
# deuteron g factor 
__b_gspin_electron = -2.0023193043622,
# electron g factor 
__b_gspin_muon = -2.0023318414,
# muon g factor 
__b_gspin_neutron = -3.82608545,
# neutron g factor 
__b_gspin_proton = 5.585694713,
# proton g factor 
__b_gspin_triton = 5.957924896,
# triton g factor

# the following dimensionless constants were not included in CODATA2006
__b_gyro_anom_electron = NaN,
__b_gyro_anom_muon = NaN,
