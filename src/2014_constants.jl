...
gyro_anom_electron = 1.15965218091e-3,
# electron magnetic moment anomaly
gyro_anom_muon = 1.16592089e-3,
# muon magnetic moment anomaly

gspin_deuteron = 0.8574382311,
# deuteron g factor 
gspin_electron = -2.00231930436182,
# electron g factor 
gspin_helion = -4.255250616,
# helion g factor 
gspin_muon = -2.0023318418,
# muon g factor 
gspin_neutron = -3.82608545,
# neutron g factor 
gspin_proton = 5.585694702,
# proton g factor 
gspin_triton = 5.957924920,
# triton g factor
...
h_bar_planck = 6.62607015e-34 / 2pi,
# h_planck/twopi [eV*s]
