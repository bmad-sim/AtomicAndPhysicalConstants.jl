...
struct Species
  ...
  function Species(name::String, charge::Int32, mass::Float64, spin::Float64, moment::Float64, iso::Int32, kind::Kind.T)
...
struct AtomicSpecies
  ...
  mass::Dict{Int32,Float64}  # a dict to store the masses, keyed by isotope all masses in amu
  #=
